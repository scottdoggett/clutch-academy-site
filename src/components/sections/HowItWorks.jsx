  ...
  return (
    <GearSection gear={3} id="how-it-works">
      ...
      <section className="first-lesson">
        ...
        <p className="first-lesson__body">
          We’ll begin by walking through the basics — how the clutch works,
          how to find the bite point, and how to move off smoothly without
          stalling. From there, you’ll quickly progress into real driving in
          low-pressure areas before gradually introducing traffic.
        </p>
        <p className="first-lesson__body">
        ...
        <p className="first-lesson__body">
          By the end of your first lesson, you won’t just understand manual
          — you’ll actually be driving it.
        </p>
      </section>
    </GearSection>
  )
